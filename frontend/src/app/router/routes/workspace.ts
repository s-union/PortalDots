...
export const workspaceRoutes: RouteRecordRaw[] = [
    ...
    {
        path: "/circles/new",
        component: () => import("@/pages/workspace/circles/CircleCreatePage.vue"),
        meta: {
            requiresAuth: true,
        },
    },
    {
        ...
        component: () => import("@/pages/workspace/circles/CircleDetailPage.vue"),
        meta: requiresWorkspace,
    },
    {
        path: "/workspace/circles/members",
        component: () => import("@/pages/workspace/circles/CircleMembersPage.vue"),
        meta: requiresWorkspace,
    },
    {
        path: "/workspace",
