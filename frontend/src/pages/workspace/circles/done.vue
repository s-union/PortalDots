...
<template>
  <PageLayout spacious>
    <SurfaceCard>
      ...
      <div class="space-y-5 px-6 py-6 text-base leading-7 text-body">
        ...
        <div
          ...
          class="rounded border border-success/20 bg-success-light px-4 py-3 text-base leading-7"
        >
        ...
        <div class="flex flex-wrap gap-3">
          <RouterLink
            class="inline-flex rounded border border-primary bg-primary px-6 py-3 text-base text-white transition hover:bg-primary-hover hover:no-underline"
            to="/"
          >
            ホームへ戻る
          </RouterLink>
