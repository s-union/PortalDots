...
import StaffDashboardPage from "./StaffDashboardPage.vue";
  ...
  it("shows staff management entry points", async () => {
    ...
    const router = createRouter({
      ...
      routes: [
        ...
        { path: "/staff/activity-logs", component: { template: "<div>activity logs</div>" } },
        ...
        { path: "/staff/permissions", component: { template: "<div>staff permissions</div>" } },
