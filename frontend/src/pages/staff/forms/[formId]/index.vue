...
<template>
  <section class="space-y-6">
    ...
    <article v-else-if="formQuery.data.value" class="space-y-6">
        ...
        <SettingsRow>
          <div class="grid gap-4 md:grid-cols-[14rem_minmax(0,1fr)] md:gap-6">
            <div class="space-y-1">
              ...
              <p class="text-xs text-muted-2">受付開始日時と受付終了日時を RFC3339 形式で入力します。</p>
            </div>
      ...
      <section id="editor-panel" class="rounded border border-border bg-surface shadow-lv1 scroll-mt-24">
