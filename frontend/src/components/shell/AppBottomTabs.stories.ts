...
const userTabs: MobileTabLink[] = [
  ...
  { to: '/workspace/forms', label: '申請', iconClass: 'fas fa-edit', active: false }
]
...
const staffTabs: MobileTabLink[] = [
  ...
  { to: '/staff/forms', label: 'フォーム', iconClass: 'fas fa-edit', active: false },
  { to: '/staff/users', label: 'ユーザー', iconClass: 'fas fa-users', active: false }
]
