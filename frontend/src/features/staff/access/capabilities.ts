...
export function hasStaffAccess(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'content_manager', 'forms_manager', 'circle_manager', 'user_manager') ||
...
export function canReadUsers(roles: string[], permissions: string[] = []) {
  return (
    ...
    hasAnyPermission(permissions, 'staff.users', 'staff.users.read,export', 'staff.users.read,edit', 'staff.users.read')
  )
}

export function canEditUsers(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'user_manager') || hasAnyPermission(permissions, 'staff.users', 'staff.users.read,edit')
  )
}
...
export function canReadPermissions(roles: string[], permissions: string[] = []) {
  return (
    ...
    hasAnyPermission(permissions, 'staff.permissions', 'staff.permissions.read,edit', 'staff.permissions.read')
  )
}

export function canEditPermissions(roles: string[], permissions: string[] = []) {
  return hasAnyRole(roles, 'admin') || hasAnyPermission(permissions, 'staff.permissions', 'staff.permissions.read,edit')
}
...
export function canEditCircles(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'circle_manager') ||
    hasAnyPermission(permissions, 'staff.circles', 'staff.circles.read,edit,delete', 'staff.circles.read,edit')
  )
}
...
export function canEditDocuments(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'content_manager') ||
    hasAnyPermission(permissions, 'staff.documents', 'staff.documents.read,edit,delete', 'staff.documents.read,edit')
  )
}
...
export function canEditFormAnswers(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'forms_manager') ||
    hasAnyPermission(permissions, 'staff.forms.answers.read,edit,delete', 'staff.forms.answers.read,edit')
  )
}

export function canDeleteFormAnswers(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'forms_manager') || hasAnyPermission(permissions, 'staff.forms.answers.read,edit,delete')
  )
}

export function canExportFormAnswers(roles: string[], permissions: string[] = []) {
  return hasAnyRole(roles, 'admin', 'forms_manager') || hasAnyPermission(permissions, 'staff.forms.answers.read,export')
}
...
export function canEditTags(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'content_manager') ||
    hasAnyPermission(permissions, 'staff.tags', 'staff.tags.read,edit,delete', 'staff.tags.read,edit')
  )
}
...
export function canEditPlaces(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'content_manager') ||
    hasAnyPermission(permissions, 'staff.places', 'staff.places.read,edit,delete', 'staff.places.read,edit')
  )
}
...
export function canDeleteContactCategories(roles: string[], permissions: string[] = []) {
  return (
    hasAnyRole(roles, 'admin', 'content_manager') ||
    hasAnyPermission(permissions, 'staff.contacts', 'staff.contacts.categories.read,edit,delete')
  )
}
...
export function canAccessStaffCapability(capability: StaffCapability, roles: string[], permissions: string[] = []) {
  switch (capability) {
    case 'users.read':
      return canReadUsers(roles, permissions)
    case 'users.edit':
