...
export type SuspenseQueryClientHelpers = {
  useSuspenseQuery<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TError = Error>(
    ...
    queryOptions?: SuspenseQueryOptions<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>>,
    options?: RequestOptions
  ): UseQueryReturnType<ResponseDataFor<TMethod, TPath>, TError>
  useSuspenseQueryData<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TData, TError = Error>(
    method: TMethod,
    path: TPath,
    init: QueryInit<RequestInitFor<TMethod, TPath>>,
...
export function createSuspenseQueryClient(client: ApiClient): SuspenseQueryClientHelpers {
  function useSuspenseQuery<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TError = Error>(
    method: TMethod,
    path: TPath,
    init: QueryInit<RequestInitFor<TMethod, TPath>>,
    queryOptions?: SuspenseQueryOptions<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>>,
    ...
    const query = useTanstackQuery<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>, QueryKey>({
      ...restQueryOptions,
