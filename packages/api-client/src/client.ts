...
export function expectApiData<TData>(result: ApiResult<TData>, message: string, errorParsers?: ApiErrorParsers) {
...
export function expectApiNoContent(result: ApiResult<unknown>, message: string, errorParsers?: ApiErrorParsers) {
