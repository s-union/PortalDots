...
type RequestInitFor<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>> = MaybeOptionalInit<
  paths[TPath],
  TMethod
>

type ResponseDataFor<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>> = MethodResponse<
  ApiClient,
  TMethod,
  TPath,
...
> & {
  queryKey?: UnwrapReactiveObject<UseQueryOptions<TQueryFnData, TError, TData, TQueryFnData, QueryKey>>['queryKey']
}

type MutationOptions<TData, TError, TVariables, TOnMutateResult> = Omit<
  Exclude<UseMutationOptions<TData, TError, TVariables, TOnMutateResult>, (...args: never[]) => unknown>,
  'mutationFn'
>
...
export type QueryClientHelpers = {
  ...
  useQuery<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TError = Error>(
    ...
    queryOptions?: QueryOptions<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>>,
    options?: RequestOptions
  ): UseQueryReturnType<ResponseDataFor<TMethod, TPath>, TError>
  useQueryData<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TData, TError = Error>(
    method: TMethod,
    path: TPath,
    init: QueryInit<RequestInitFor<TMethod, TPath>>,
    select: SelectData<ResponseDataFor<TMethod, TPath>, TData>,
  ...
  >(
    ...
    >,
    options?: RequestOptions
  ): UseMutationReturnType<ResponseDataFor<TMethod, TPath>, TError, RequestInitFor<TMethod, TPath>, TOnMutateResult>
  useMutationData<
    TMethod extends MutationMethod,
    TPath extends PathWithMethod<TMethod>,
    TData,
  ...
  >(
    ...
    path: TPath,
    select: SelectData<ResponseDataFor<TMethod, TPath>, TData>,
    mutationOptions?: MutationOptions<TData, TError, RequestInitFor<TMethod, TPath>, TOnMutateResult>,
    options?: RequestOptions
  ...
  >(
    method: TMethod,
    path: TPath,
    mutationOptions?: MutationOptions<void, TError, RequestInitFor<TMethod, TPath>, TOnMutateResult>,
    options?: RequestOptions
...
export function createQueryClient(client: ApiClient): QueryClientHelpers {
  ...
  function useQuery<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TError = Error>(
    method: TMethod,
    path: TPath,
    init: QueryInit<RequestInitFor<TMethod, TPath>>,
    queryOptions?: QueryOptions<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>>,
    ...
    return useTanstackQuery<ResponseDataFor<TMethod, TPath>, TError, ResponseDataFor<TMethod, TPath>, QueryKey>({
      ...restQueryOptions,
  ...
  function useQueryData<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>, TData, TError = Error>(
    method: TMethod,
    path: TPath,
    init: QueryInit<RequestInitFor<TMethod, TPath>>,
    select: SelectData<ResponseDataFor<TMethod, TPath>, TData>,
  ...
  function mutationData<TMethod extends MutationMethod, TPath extends PathWithMethod<TMethod>, TData>(
    method: TMethod,
    path: TPath,
    init: RequestInitFor<TMethod, TPath>,
    select: SelectData<ResponseDataFor<TMethod, TPath>, TData>,
  ...
  function noContentMutation<TMethod extends MutationMethod, TPath extends PathWithMethod<TMethod>>(
    method: TMethod,
    path: TPath,
    init: RequestInitFor<TMethod, TPath>,
    options?: RequestOptions
...
async function requestData<TMethod extends HttpMethod, TPath extends PathWithMethod<TMethod>>(
  ...
  return expectApiData(result, options?.errorMessage ?? buildErrorMessage(method, path), options?.errorParsers)
}

async function requestNoContent<TMethod extends MutationMethod, TPath extends PathWithMethod<TMethod>>(
  client: ApiClient,
  method: TMethod,
  path: TPath,
  init: RequestInitFor<TMethod, TPath>,
  ...
  const result = await callClientMethod(client, method, path, init)
  expectApiNoContent(result, options?.errorMessage ?? buildErrorMessage(method, path), options?.errorParsers)
}
