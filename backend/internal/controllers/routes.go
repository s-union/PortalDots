...
func RegisterStaffRoutes(v1 *echo.Group, r StaffRoutes, middlewares ...echo.MiddlewareFunc) {
	...
	staff.GET("/tags/export", r.DownloadStaffTagsCSV, RequireCapability(canExportTags))
	...
	staff.GET("/places/export", r.DownloadStaffPlacesCSV, RequireCapability(canExportPlaces))
