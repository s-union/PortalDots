...
func NewServerWithDependencies(
	...
	RegisterStaffRoutes(v1, StaffRoutes{
		...
		SearchStaffFormRecipientCandidates: staffFormH.searchStaffFormRecipientCandidates,
		GetStaffFormRecipientCandidate:     staffFormH.getStaffFormRecipientCandidate,
		// Participation Types
