...
SELECT id, title, body, notes, is_pinned, is_public, viewable_tags, document_ids, created_at, updated_at, published_at
FROM pages
...
-- name: CreatePage :one
INSERT INTO pages (title, body, notes, is_pinned, is_public, viewable_tags, document_ids, published_at)
VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
RETURNING id, title, body, notes, is_pinned, is_public, viewable_tags, document_ids, created_at, updated_at, published_at;
