...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('group.belongsTo', 'App\Policies\Group\BelongsPolicy');
        Gate::define('group.update', 'App\Policies\Group\UpdatePolicy');
        Gate::define('group.create', 'App\Policies\Group\CreatePolicy');
    }
}
