...
{
    public function __construct(private readonly CirclesService $circlesService, private readonly AnswerDetailsService $answerDetailsService)
    {
    }
    ...
    public function __invoke(SubmitRequest $request, Circle $circle)
    {
        ...
        $formLastUpdatedAt = \Illuminate\Support\Facades\Date::createFromTimestamp($request->validated()['last_updated_timestamp']);
        ...
        return to_route('circles.done', ['circle' => $circle])
            ->with('done', true);
    }
}
