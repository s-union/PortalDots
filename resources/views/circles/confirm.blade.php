...
@section('content')
    @include('includes.circle_register_header', ['should_register_group' => $should_register_group])
    ...
    <app-container medium>
        <list-view>
            ...
            <list-view-card>
                @include('includes.circle_info', ['should_register_group' => $should_register_group])
            </list-view-card>
        </list-view>
